...
function DetailsContainer(props) {
    ...
    return (
        <div>
            ...
            <div className=" grid justify-center sm:w-96 2xl:w-1/2 mx-6 sm:mx-auto p-5 rounded-2xl shadow-2xl my-10 sm:my-20 space-y-2  text-center text-xl text-orange-400">
